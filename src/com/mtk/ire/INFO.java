...
public class INFO {
	...
	public static final String TITLES_FILE = "/media/mtk/soft/main/titles-prod";
	
	
	public static final String MAIN_DUMP = "/home/mtk/enwiki-latest-pages-articles.xml";
	public static final long PRINT_BLOCK = 30000; // number of files
	public static final int INDEX_SPLIT_BLOCK = 80000;
