...
public class IndexGenerator {
	...
	static void createPrimaryIndex() throws Exception {
		String inp = "/media/mtk/soft/tmp/main/merged-prod1-300";
		String posList = "/home/mtk/ireIndex/merged-prod1-300.justPostingList";
		String terms = "/home/mtk/ireIndex/merged-prod1-300.justTerms";
	...
	static void createSecondaryIndex() throws Exception {
		String inp= "/home/mtk/ireIndex/merged-prod1-300.justTerms";
		String secOut = "/home/mtk/ireIndex/merged-prod1-300.justTerms.2nd";
	...
	static TreeMap<String,Long> readSecondaryIndex() throws Exception {
		String inp = "/home/mtk/ireIndex/merged-prod1-300.justTerms.2nd";
		BufferedReader br = new BufferedReader(new FileReader(inp));
